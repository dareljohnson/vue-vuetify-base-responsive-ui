<template>
  <v-app>
    ...
    >
      <v-list class="pa-1" v-if="loggedIn" v-cloak>
        <v-list-tile avatar>
          <v-list-tile-avatar>
            <img
              src="https://media.licdn.com/dms/image/C5103AQFMjzfxBfz9tw/profile-displayphoto-shrink_200_200/0?e=1563408000&v=beta&t=WC0KEye7D8_47RJpbx_HzVKNX39pnPstrfSKXVNX7kk"
            >
          </v-list-tile-avatar>
          <v-list-tile-content>
    ...
    <!-- Toolbar -->
    <v-toolbar app fixed class="toolbar" v-cloak color="primary">
      <v-toolbar-side-icon v-on:click.stop="sideNav = !sideNav" class="hidden-sm-and-up"></v-toolbar-side-icon>
